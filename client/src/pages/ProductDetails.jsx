    ...
    return product && (
        <div className="mt-12">
            ...
            <div className="flex flex-col items-center mt-20">
                ...
                <button onClick={()=> {navigate('/products'); scrollTo(0,0)}} className="mx-auto cursor-pointer px-12 my-16 py-2.5 border rouned text-primary hover:bg-primary/10 transition">See more</button>
            </div>
        </div>
    );
};
