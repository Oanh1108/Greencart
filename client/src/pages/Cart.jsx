...
const Cart = () => {
    ...
    const [selectedAddress, setSelectedAddress] = useState(null) //dòng này sửa
    ...
    try {
        ...
        if(data.success){
            ...
            setSelectedAddress(data.address[0]); // <-- sửa ở đây
        }else{
                        ...
                        {showAddress && (
                            ...
                            <p
                                ...
                                className={`text-gray-500 p-2 hover:bg-gray-100 cursor-pointer ${
                                    selectedAddress === addr ? "bg-gray-100 font-medium" : ""
                                }`}
                            >
